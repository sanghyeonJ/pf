...
$(function(){
    ...
    $(document).ready(function() {
        ...
        $('.inputClear').after('<button type="button" class="inputClearBtn"><img src="../../resources/images/inputClear.png" alt="초기화"></button>');
    ...
    if($(window).width() < 1200) {
        $(document).on('click', '.equipListItem', function(){
            $('.equipView').show();
        })
        $(document).on('click', '.btn_equipPopupClose', function(){
            $('.equipView').hide();
        })
    }
